    ...
    <main className="min-h-screen bg-emerald-50 text-slate-900 px-5 sm:px-8 py-10 flex items-center justify-center">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white/70 border border-white rounded-3xl p-6 sm:p-8 mt-4">
          ...
          <p className="text-sm text-slate-500 mb-6">Save your scan history and personalize Givo Food Analyzer.</p>
          ...
          {done ? (
            <div className="flex items-start gap-2 text-sm rounded-xl p-3 border bg-emerald-50 border-emerald-100 text-emerald-700">
              ...
              Check your inbox — we sent a verification link to <strong>{email}</strong>. Confirm your email, then log in.
            </div>
          ) : (
            <>
              {error && (
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 py-2.5 rounded-xl font-medium border border-black/10 bg-white disabled:opacity-60"
              >
...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48">
      ...
      <path fill="#4CAF50" d="M24 44c5.5 0 10.4-1.9 14.2-5.1l-6.6-5.4C29.6 35 26.9 36 24 36c-5.3 0-9.7-3.3-11.3-8l-6.6 5C9.9 39.7 16.4 44 24 44z" />
      <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.2-4.3 5.5l6.6 5.4C41.4 35.6 44 30.2 44 24c0-1.3-.1-2.7-.4-3.5z" />
    </svg>
  );
}

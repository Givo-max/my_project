  ...
  return (
    <div className="relative inline-flex items-center justify-center" style={{ width: size, height: size }}>
      <svg className="transform -rotate-90" width={size} height={size}>
        ...
        <circle cx={size/2} cy={size/2} r={radius} stroke="#0d9488" strokeWidth={strokeWidth} fill="transparent" strokeDasharray={circumference} strokeDashoffset={offset} strokeLinecap="round" className="transition-all duration-1000" />
      </svg>
          ...
          <>
            ...
            <section className="mt-12">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-bold tracking-tight">Your Recent Scans</h3>
              </div>
              {historyList.length === 0 ? (
                <div className={`p-6 rounded-2xl border text-center text-sm italic ${darkMode ? "bg-white/5 border-white/5 text-white/40" : "bg-white border-slate-100 text-slate-400"}`}>
                  No recent meal scans found. Your analyzed foods will be stored safe locally.
                </div>

...
import { Loader2, LogOut, ShieldCheck, Settings, Database, FileText } from "lucide-react";
...
export default function AdminPage() {
  ...
  const upcoming = [
    { icon: Settings, label: "Website Settings", note: "Logo, SMTP, API keys, AdSense — coming next" },
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-emerald-50 px-5 sm:px-8 py-10">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-5 mb-6 text-sm text-slate-300">
          Authentication and role-based access are live. The full Admin Control Center
          (site settings, food database, blog, analytics) is being built next, phase by phase.
        </div>
